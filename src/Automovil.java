/*private solo acesible desde la clase,
para obtener fuera de la clase se debe
crear un metodo publico

statico es para la clase no para las instancias
solo se pueden ocupar  metodos estaticos
para variables estaticas*/
...
public class Automovil  implements Comparable<Automovil>{
    ...
    public static final int VELOCIDAD_MAX_CUIDAD=60;
    ...
    public String verDetalle(){
        ...
        if (this.conductor != null){
            detalle+="\nauto.cilindrada= "+this.getConductor();
        }
        detalle+="\nauto.modelo = " + this.modelo+
                "\nauto.patenteColor= "+Automovil.colorPatente.getColor();
        if (getRuedas()!= null){
            detalle+="\nRuendas del automovil: ";
    ...
    public String acelerarFrenar(int rpm){
        String acelear=this.acelerar(rpm);
